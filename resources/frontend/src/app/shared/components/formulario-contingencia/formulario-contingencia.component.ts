...
@Component({
  selector: 'formulario-contingencia',
  templateUrl: './formulario-contingencia.component.html',
  styleUrls: ['./formulario-contingencia.component.css']
})
export class FormularioContingenciaComponent implements OnInit {
