...
class Vigilancia extends Model
{
    ...
    protected $fillable = ['id', 'clinica_id', 'nombre_paciente', 'municipio_id', 'edad', 'sexo', 'fecha_inicio', 'fecha_ingreso', 'fecha_intubado', 'folio_pcr', 'no_caso', 'diagnostico', 'estatus_paciente_id', 'estatus_egreso_id', 'intubado', 'servicio_cama', 'pco_fipco', 'saturado_02', 'observaciones', 'ventilador', 'monitor', 'bomba_infusion', 'no_bombas'];
