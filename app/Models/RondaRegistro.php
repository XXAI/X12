...
class RondaRegistro extends Model
{
    ...
    protected $fillable = ['id','ronda_id','no_brigada','fecha_registro','cabecera_recorrida_id','localidad_id','colonia_visitada_id','casas_visitadas','casas_promocionadas','casas_encuestadas','casas_deshabitadas','casas_ausentes','casas_renuentes','pacientes_referidos_valoracion','pacientes_referidos_hospitalizacion','pacientes_candidatos_muestra_covid','creado_por','modificado_por','borrado_por'];
