...
import { ConcentradosService } from '../visor-concentrados.service';
...
export class VisorConcentradosComponent implements OnInit {
  ...
  constructor(
    ...
    public concentradosService: ConcentradosService,
  ...
  public loadFilterCatalogs() {
    this.concentradosService.getFilterCatalogs().subscribe(
      response => {
